...
public class SubscriptionApiController {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "구독 성공"), @ApiResponse(responseCode = "401", description = "인증 필요"), @ApiResponse(responseCode = "409", description = "이미 구독 중인 키워드")})
    @PostMapping
    ...
    public GlobalResponseDto<SubscriptionResponse> updateSubscription(@AuthenticationPrincipal MemberPrincipal principal, @PathVariable Integer subscriptionId, @RequestBody SubscriptionUpdateRequest request) {
